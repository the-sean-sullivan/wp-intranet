...
class Srs_Intranet_Loader {
	 ...
	 * @since    1.0.0
	 * @access   protected
	 * @var      array    $remove_action    The remove actions registered with WordPress to fire when the plugin loads.
	 */
	...
	public function remove_action( $hook, $component, $callback, $priority = 10 ) {
		$this->remove_action = $this->remove( $this->remove_action, $hook, $component, $callback, $priority );
	}
	...
	public function run() {
		...
		foreach ( $this->remove_action as $hook ) {
